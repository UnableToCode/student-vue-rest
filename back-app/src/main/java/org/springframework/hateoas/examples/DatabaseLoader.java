...
class DatabaseLoader {
	...
	CommandLineRunner init(StudentRepository repository) {
		...
		return args -> {
			repository.save(new Student("171860627", "Frodo", "Baggins", "male", "1998-10-4", "Nanjing", "CS"));
			repository.save(new Student("171860628", "Bilbo", "Baggins", "famale", "1999-6-17", "Shanghai", "SE"));
		};
	}
